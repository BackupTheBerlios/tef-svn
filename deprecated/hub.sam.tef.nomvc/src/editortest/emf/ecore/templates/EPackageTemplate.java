...
public class EPackageTemplate extends EModelElementTemplate {
	...
	public EPackageTemplate(IDocumentModelProvider modelProvider) {
		super(modelProvider, modelProvider.getModel().getMetaElement("EPackage"));
	}
	
	@Override
	public Template[] getContentsTemplates() {
		return new Template[] {
				new SequenceTemplate<IModelElement>(this, "eSubpackages", null, true) {
					@Override
