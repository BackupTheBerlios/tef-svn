...
public class TDLChoiceClassReferenceCompletion extends SingleReductionCompletion {

	@Override
	public Rule getRule() {
		return new Rule( new String[] { "TDLChoiceTemplate", "'choice'", "`identifier`", "'for'" });
	}

	@Override
	public String[] getRulePrefix() {
		return new String[] { "'choice'", "`identifier`", "'for'" };
	}
