...
public class TDLReferenceClassReferenceCompletion extends SingleReductionCompletion {

	@Override
	public Rule getRule() {
		return new Rule( new String[] { "TDLReferenceTemplate", "'('", "'ref'", "'for'" });
	}

	@Override
	public String[] getRulePrefix() {
		return new String[] { "'('", "'ref'", "'for'" };
	}
